...
Pipeline:  Client -> Profile Agent -> Needs Agent -> Product Agent -> ROI Engine
           -> Compliance Agent -> Executive Report
"""
...
NODE_ORDER = ["profile", "needs", "product", "roi", "compliance", "executive"]
